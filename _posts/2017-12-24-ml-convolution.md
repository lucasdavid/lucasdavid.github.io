...
images:
- url: /assets/ml/deep/convnet.png
  alt: "Exemplo de rede convolucional aplicada ao processamento de imagens."
  title: "Exemplo de rede convolucional aplicada ao processamento de imagens."
---

# Convoluções: o início de *deep-learning*
...
De onde vem a ideia de *deep-learning* e *deep-models*, então? Vamos voltar à
...
`InceptionResNetV2`, treinada sobre o imagenet, sabe com bastante certa o que é um koala. :-)
