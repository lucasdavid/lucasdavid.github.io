...
lead_image: /assets/images/posts/ml/intro/ml-computing.webp
...
{% include figure.html
   src="/assets/images/posts/ml/intro/classic-computing.webp"
   alt="Computação 'clássica'"
   caption="Soluções computacionais 'clássicas'." %}
