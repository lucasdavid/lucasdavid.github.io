...
SSH into the buttler once more and you will now be connected to SDumont!
...
-----|----------|------------
Scratch | 25 TB | input, transient and output data
Home | 5 TB | source-code, libraries
...
### Submitting Jobs
#### NVIDIA Queues
Should be used for the small experiments (two GPUs are available).
...
```shell
module load cuda/11.2 python/3.8.2
virtualenv envs/p38/ --python python3.8
source envs/p38/bin/activate
pip install -U tensorflow-gpu==2.6.0 tensorflow-datasets
```
